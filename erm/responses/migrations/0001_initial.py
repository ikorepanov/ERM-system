# Generated by Django 4.2.4 on 2023-12-22 09:04
    ...
    operations = [
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("TES", "Тестовое"),
                            ("INH", "Интервью с HR"),
                            ("INT", "Интервью с тимлидом"),
                            ("INB", "Интервью с вампиром"),
                            ("OFF", "Оффер!"),
                        ],
                        default="OTP",
                        max_length=3,
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("first_name", "last_name", "phone"), name="unique_person_phone"
            ),
        ),
        migrations.AddConstraint(
            model_name="contact",
            constraint=models.UniqueConstraint(
                fields=("first_name", "last_name", "email"), name="unique_person_email"
            ),
        ),
        migrations.AddConstraint(
            model_name="contact",
